...
public class App {
  ...
  static Stack<String> commandHistory = new Stack<>(10); // push, pop
  static Queue<String> commandHistory2 = new Queue<>(10); // offer, poll
  ...
  private static void printCommandHistory() {
    // 스택은 pop하면 사라지는 특성이 있으므로 데이터를 잃지 않기 위해 clone으로 객체를 복사함
